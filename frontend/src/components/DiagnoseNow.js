...
const PlantDiseaseSection = () => {
  return (
    <section className="bg-white py-16 px-6 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center justify-between">
      ...
      <div className="flex-1 lg:max-w-[50%] text-center lg:text-left mt-8 lg:mt-14">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-green-900">
          Identify and cure <span className="text-green-500">plant diseases</span> with Blossom
        </h2>
        <p className="mt-8 text-gray-500 text-lg">
          Is your green buddy dying? Try the Blossom app to identify the cause and get extensive disease
          and care info in a snap.
        </p>
